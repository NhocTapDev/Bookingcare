        ...
        <div className='login-content row'>
          ...
          <div className='col-12 form-group login-form'>
            ...
            <input
              ...
              onKeyDown={(event) => handleKeyDown(event)}
            ></input>
            <i className={isShowPassword ? 'far fa-eye password-icon' : 'far fa-eye-slash password-icon'} onClick={(event) => handleShowHidePassword(event)}></i>
          </div>
          <div className='col-12' style={{ color: "red" }}>
            {errMessage}
          </div>
          <div className='col-12'>
            <span className='forgot-password' onClick={() => { history.push("/forgot-password"); }}>
          ...
          <div className='col-12 social-login'>
            <i onClick={handleSignInGoogle} className='fab fa-google-plus-g google-icon'></i>
          ...
          <div className='col-12 section-signup'>
            ...
            <span className='sign-up' onClick={() => { history.push("/sign-up"); }}>
